...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('status').then(function (response) {
      return _this.columns = response.data.data;
    })["catch"](function (error) {
      console.log(error);
    });
  },
  methods: {
    showAddColumnForm: function showAddColumnForm() {
    ...
    deleteColumn: function deleteColumn(id) {
      ...
      if (confirm('Are You Sure?')) {
        axios.post('status/delete', {
          ...
          _this3.columns = _this3.columns.filter(function (column) {
            return column.id != id;
          });
        })["catch"](function (error) {
          return console.log(error);
    ...
    addCardToColumn: function addCardToColumn(data, card) {
    ...
    showAddCardForm: function showAddCardForm(id) {
      this.column_id = id;
    ...
    addCard: function addCard() {
      ...
      axios.post('cards', {
        ...
        _this4.$modal.hide('cardForm');

        _this4.addCardToColumn(response.data.data, _this4.card);

        _this4.card.id = false;
        _this4.card.title = '';
        _this4.card.description = '';
        _this4.column_id = false;
      })["catch"](function (error) {
        return console.log(error);
      });
    },
    updateCardOrder: function updateCardOrder(_ref) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      click: function click($event) {
        return _vm.showAddColumnForm();
      }
    }
  }, [_vm._v("Add Column")])]), _vm._v(" "), _c("div", {
    staticClass: "columns"
  }, _vm._l(_vm.columns, function (column) {
    return _c("div", {
      key: column.id,
      staticClass: "column shadow"
    }, [_c("div", {
      staticClass: "columnHeader"
    }, [_c("h3", [_vm._v(_vm._s(column.title))]), _vm._v(" "), _c("div", [_c("button", {
      staticClass: "btn addColumn",
      on: {
        click: function click($event) {
          return _vm.showAddCardForm(column.id);
        }
      }
    }, [_vm._v("Add Card")]), _vm._v(" "), _c("button", {
      staticClass: "deleteColumn",
      on: {
        click: function click($event) {
          return _vm.deleteColumn(column.id);
        }
      }
    }, [_vm._v("X")])])]), _vm._v(" "), _c("draggable", {
      staticClass: "list-group kanban-column",
      attrs: {
        move: _vm.updateCardOrder,
        list: column.cards,
        animation: 200,
      ...
      return _c("task-component", {
        ...
        on: {
          "show-card-details": function showCardDetails($event) {
            return _vm.showCardDetails(card);
          }
        }
      });
    }), 1)], 1);
  ...
  }, [_c("h3", [_vm._v("Add New Column")]), _vm._v(" "), _c("div", {
    staticClass: "form-group"
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.column.title,
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.column, "title", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("button", {
  ...
  }, [_vm._v("Save")])])]), _vm._v(" "), _c("modal", {
    attrs: {
      name: "cardForm"
    }
  }, [_c("form", {
    staticClass: "cardForm",
    on: {
      submit: function submit($event) {
        $event.preventDefault();
  ...
  }, [_c("h3", [_vm._v("Card")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.column_id,
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.column_id = $event.target.value;
      }
    }
  }), _vm._v(" "), _c("div", {
    staticClass: "form-group"
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.card, "description", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("button", {
    staticClass: "btn btn-success",
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      click: function click($event) {
        return _vm.$emit("show-card-details", _vm.card);
      }
    }
  }, [_c("h5", [_vm._v(_vm._s(_vm.card.title))]), _vm._v(" "), _c("span", {
    staticClass: "text-sm"
  }, [_vm._v(_vm._s(_vm.card.created))])]);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue_js_modal_dist_index_nocss_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-js-modal/dist/index.nocss.js */ "./node_modules/vue-js-modal/dist/index.nocss.js");
/* harmony import */ var vue_js_modal_dist_index_nocss_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue_js_modal_dist_index_nocss_js__WEBPACK_IMPORTED_MODULE_0__);
